...
## Workstream 1: installation and lifecycle
...
manual unit files, or provider credentials entering QML.

## Workstream 2: developer environment discovery
...
calling a provider merely to score a request.

## Workstream 3: verified coding-agent integrations
...
connection can be reviewed and reversed.

## Workstream 4: Omarchy-native daily surface
...
advanced configuration remains transparent and file-based.

## Workstream 5: project-aware routing
...
control plane, hosted identity, or request-path storage dependency.

## Workstream 6: release and community hardening
...
and an explicit supported-environment matrix.

## Pull-request sequence

1. strategy ADR, roadmap, front-door copy, and issue reset;
2. first-run initialization and user-service lifecycle;
3. Omarchy-aware doctor and local-runtime discovery;
4. first two verified agent integrations;
5. panel receipt and remediation polish;
6. project-aware profile resolution;
7. update, rollback, compatibility CI, and release documentation;
